...
final class NYCSchoolTests: XCTestCase {
    ...
    func testNYCSchool() throws {
        ...
        XCTAssertEqual(school.address, "10 East 15th Street, Manhattan NY 10003 ")
        XCTAssertEqual(school.coordinates, ["latitude":"40.736526","longitude":"-73.992727"])
    }
}
